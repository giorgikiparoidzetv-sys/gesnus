...
(
  ...
  'Thunder X White Portion delivers an intense snus experience with powerful tobacco character and extra strength. The white portion format provides clean taste delivery and minimal drip.', 
  'თანდერ ხ ვაიტ პორშენ იძლევა ინტენსიურ სნუს გამოცდილებას ძლიერი თუთუნის ხასიათით.',
  ...
  'Thunder X White Portion - Extra Strong Snus | Premium Quality', 'Experience the power of Thunder X White Portion snus with intense tobacco flavor.', 'src/assets/product-23.jpg', now(), now()
),
...
(
  ...
  'Skruf Super White Slim represents the finest in Swedish snus craftsmanship. This premium white portion offers a perfectly balanced tobacco flavor.',
  ...
  'Skruf Super White Slim - Premium Swedish Snus | Refined Taste', 'Discover Skruf Super White Slim snus with refined tobacco taste.', 'src/assets/product-24.jpg', now(), now()
),
...
(
  ...
  'XQS Pipe Candy brings a playful twist to nicotine pouches with its sweet candy flavor.', 
  'იქსქუს ფაიფ კენდი მოაქვს სახალისო ნაკლისი ნიკოტინის ჩანთებში.',
...
(
  ...
  'Velo Ice Cool Mint delivers an intensely refreshing experience with its icy mint flavor.', 
  'ველო აისი კულ მინტი იძლევა ინტენსიურად გამაგრილებელ გამოცდილებას.',
  'Velo', 'Strong', 10.0, ARRAY['mint', 'cooling', 'fresh'], 5.49, 'GEL', 73, 'VLO-ICM-005', 'src/assets/product-27.jpg', true, 'Nicotine Pouches',
  'Velo Ice Cool Mint - Refreshing Nicotine Pouches | Cooling Effect', 'Experience Velo Ice Cool Mint nicotine pouches with intense cooling.', 'src/assets/product-27.jpg', now(), now()
),
...
(
  ...
  'ზინ კულ მინტი გთავაზობთ რბილ და გამაგრილებელ მინტის გამოცდილებას.',
...
(
  ...
  'Catch Eucalyptus White Mini combines the refreshing taste of eucalyptus with mini portions.', 
  'კეჩ ევკალიპტი ვაიტ მინი აერთებს ევკალიპტის გამაგრილებელ გემოს.',
...
(
  ...
  'Loop Jalapeño Lime Strong delivers an exciting flavor adventure with spicy jalapeño heat and lime freshness.', 
  ...
  'Loop Jalapeño Lime Strong - Spicy Nicotine Pouches | Bold Flavor', 'Experience Loop Jalapeño Lime Strong with exciting flavors.', 'src/assets/product-32.jpg', now(), now()
),
...
(
  ...
  'Kapten White Original honors the Swedish snus tradition with its authentic tobacco character.', 
  ...
  'Kapten White Original - Traditional Swedish Snus | Authentic Taste', 'Discover Kapten White Original with traditional tobacco flavor.', 'src/assets/product-33.jpg', now(), now()
),
...
(
  ...
  'Pablo Ice Cold Extra Strong is designed for users seeking maximum strength and intense cooling.', 
  ...
  'Pablo Ice Cold Extra Strong - Extreme Nicotine Pouches | Maximum Strength', 'Experience Pablo Ice Cold Extra Strong with extreme strength.', 'src/assets/product-34.jpg', now(), now()
),
...
(
  ...
  'Lyft Berry Frost combines the sweetness of mixed berries with refreshing cooling.', 
  'ლიფტ ბერი ფროსტი აერთებს შერეული კენკროვნების სიტკბოს.',
  'Lyft', 'Regular', 8.0, ARRAY['berry', 'frost', 'fruity'], 4.79, 'GEL', 65, 'LFT-BF-013', 'src/assets/product-35.jpg', false, 'Nicotine Pouches',
  'Lyft Berry Frost - Fruity Nicotine Pouches | Berry Cooling', 'Enjoy Lyft Berry Frost with mixed berry flavor.', 'src/assets/product-35.jpg', now(), now()
),
...
(
  ...
  'ON! Citrus 8mg offers a bright and zesty citrus flavor in a moderate strength pouch.', 
...
(
  ...
  'G.4 Blue Mint Slim White represents premium Swedish snus craftsmanship with refreshing mint.', 
  ...
  'G.4 Blue Mint Slim White - Premium Mint Snus | Slim Format', 'Experience G.4 Blue Mint Slim White with refreshing mint.', 'src/assets/product-37.jpg', now(), now()
),
...
(
  ...
  'Ace Eucalyptus Extra Strong delivers powerful eucalyptus flavor with extra strength nicotine.', 
  ...
  'Ace Eucalyptus Extra Strong - Powerful Nicotine Pouches | Intense Freshness', 'Experience Ace Eucalyptus Extra Strong with powerful eucalyptus.', 'src/assets/product-38.jpg', now(), now()
),
...
(
  ...
  'Killa Cold Mint Extra Strong is designed for experienced users seeking maximum strength.', 
  ...
  'Killa Cold Mint Extra Strong - Extreme Nicotine Pouches | Intense Mint', 'Experience Killa Cold Mint Extra Strong with extreme strength.', 'src/assets/product-40.jpg', now(), now()
),
...
(
  ...
  'White Fox Full Charge Max - Maximum Strength Nicotine Pouches | Premium Quality', 'Experience White Fox Full Charge Max with maximum strength.', 'src/assets/product-41.jpg', now(), now()
),
...
(
  ...
  'Iceberg Watermelon Medium offers a sweet and refreshing watermelon flavor.', 
...
(
  ...
  'Volt Frosted Apple Strong combines the crisp taste of fresh apples with cooling frost.', 
...
(
  ...
  'Corvus Blackcurrant Strong offers a unique combination of rich blackcurrant flavor.', 
...
(
  ...
  'Klint Honeymelon Slim White offers a delightfully sweet honeydew melon flavor.', 
  ...
  'Klint Honeymelon Slim White - Sweet Melon Nicotine Pouches | Premium Quality', 'Enjoy Klint Honeymelon Slim White with delightful honeydew melon.', 'src/assets/product-47.jpg', now(), now()
),
...
(
  ...
  'RITE Cola Strong brings the nostalgic taste of classic cola to nicotine pouches.', 
...
(
  ...
  'Zone X Cold Blast Extra Strong delivers the ultimate cooling experience.', 
  ...
  'Zone X Cold Blast Extra Strong - Extreme Cooling Pouches | Maximum Strength', 'Experience Zone X Cold Blast Extra Strong with ultimate cooling.', 'src/assets/product-49.jpg', now(), now()
),
...
(
  ...
  'Nordic Spirit Elderflower Slim White offers an elegant and sophisticated elderflower flavor.', 
  ...
  'Nordic Spirit Elderflower Slim White - Elegant Nicotine Pouches | Premium Quality', 'Discover Nordic Spirit Elderflower Slim White with sophisticated flavor.', 'src/assets/product-50.jpg', now(), now()
),
...
(
  ...
  'Thunder Frosted Mint Strong combines intense mint flavor with powerful cooling sensation.',
  'თანდერ ფროსტად მინტ სტრონგი აერთებს ინტენსიურ მინტის გემოს ძლიერ გაცივების სენსაციასთან.',
  'Thunder', 'Strong', 12.0, ARRAY['mint', 'frosted', 'strong'], 6.29, 'GEL', 35, 'THN-FMS-029', 'src/assets/thunder-frosted.jpg', false, 'Portion Snus',
  'Thunder Frosted Mint Strong - Intense Mint Snus | Extra Strength', 'Experience Thunder Frosted Mint Strong with intense mint flavor.',
...
(
  ...
  'General G.4 Fizzy introduces an innovative snus experience with a unique fizzy sensation.',
  ...
  'General G.4 Fizzy - Innovative Fizzy Snus | Unique Sensation', 'Discover General G.4 Fizzy with unique effervescent sensation.',
...
(
  ...
  'Lundgrens Västkusten captures the essence of Sweden west coast with unique blend of sea breeze and salt notes.',
  ...
  'Lundgrens Västkusten - Maritime Swedish Snus | Sea Breeze Flavor', 'Experience Lundgrens Västkusten with unique sea breeze and salt notes.',
...
(
  ...
  'Odens Vanilla Extreme offers a luxurious vanilla flavor experience combined with extra strong nicotine.',
  ...
  'Odens Vanilla Extreme - Rich Vanilla Snus | Extra Strong', 'Discover Odens Vanilla Extreme with luxurious vanilla flavor.',
...
(
  ...
  'Skruf Nordic Blue embodies the essence of Scandinavian nature with sophisticated blend of wild blueberry and pine forest notes.',
  ...
  'Skruf Nordic Blue - Premium Nordic Snus | Blueberry & Pine', 'Experience Skruf Nordic Blue with authentic Scandinavian blueberry and pine flavors.',
