...
const translations = {
  en: {
    ...
    "admin.access_denied.message": "You don't have permission to access the admin panel.",
    ...
    "admin.orders.mark_completed": "Mark as Completed",
    "admin.orders.mark_processing": "Mark as Processing",
  ...
  ka: {
    ...
    "checkout.form.title": "მიწოდების ინფორმაცია",
    "checkout.form.full_name": "სრული სახელი",
    "checkout.form.email": "ელფოსტის მისამართი",
    "checkout.form.phone": "ტელეფონის ნომერი",
    "checkout.form.address": "მიწოდების მისამართი",
    "checkout.form.full_name_placeholder": "შეიყვანეთ თქვენი სრული სახელი",
    "checkout.form.email_placeholder": "შეიყვანეთ ელფოსტის მისამართი",
    "checkout.form.phone_placeholder": "შეიყვანეთ ტელეფონის ნომერი",
    "checkout.form.address_placeholder": "შეიყვანეთ მიწოდების მისამართი",
    "checkout.order_summary": "შეკვეთის შეჯამება",
    "checkout.subtotal": "ქვეჯამი",
    "checkout.delivery_fee": "მიწოდების საფასური",
    "checkout.total": "ჯამური",
    "checkout.place_order": "შეკვეთის გაფორმება",
    "checkout.required_field": "ეს ველი სავალდებულოა",
    "checkout.invalid_email": "გთხოვთ შეიყვანოთ სწორი ელფოსტის მისამართი",
    ...
    "admin.dashboard": "მთავარი გვერდი",
    "admin.orders": "შეკვეთები",
    "admin.products": "პროდუქტები",
    "admin.access_denied": "წვდომა აკრძალულია",
    "admin.access_denied.message": "თქვენ არ გაქვთ ადმინ პანელზე წვდომის უფლება.",
    "admin.orders.title": "შეკვეთების მართვა",
    "admin.orders.total": "ჯამური შეკვეთები",
    "admin.orders.pending": "მოლოდინში",
    "admin.orders.processing": "დამუშავებაში",
    "admin.orders.completed": "დასრულებული",
    "admin.orders.id": "შეკვეთის ID",
    "admin.orders.customer": "მყიდველი",
    "admin.orders.email": "ელფოსტა",
    "admin.orders.phone": "ტელეფონი",
    "admin.orders.address": "მისამართი",
    "admin.orders.date": "თარიღი",
    "admin.orders.status": "სტატუსი",
    "admin.orders.subtotal": "ქვეჯამი",
    "admin.orders.delivery_fee": "მიწოდების საფასური",
    "admin.orders.total_amount": "ჯამური თანხა",
    "admin.orders.items": "პროდუქტები",
    "admin.orders.update_status": "სტატუსის განახლება",
    "admin.orders.mark_completed": "დასრულებულად მონიშვნა",
    "admin.orders.mark_processing": "დამუშავებაში მონიშვნა",
    "admin.orders.view_details": "დეტალების ნახვა",
